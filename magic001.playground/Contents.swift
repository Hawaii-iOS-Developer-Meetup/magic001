...
//TODO: Gather list of adjectives from each color area.
//TODO: Determine current locale and climeate by randomly setting a color. Pull from lore.
print("")
print("Two planeswalkers meet in a shadowy grove. They are both weakened in significant ways. Their foe must never know. Or they would attack with unbridled hostility.")

// Prints out players and what they currently hold in their hands.
//TODO: Put hand inside Player struct


print("")
print("\(playerOne.name) has \(playerOne.mana) mana")
print("")
